        ...
        <div class="row gy-4 gy-md-0">
            <div
                ...
                <div style="max-width: 500px;">
                    <h1 class="display-6 fw-bold mb-4" data-aos="fade-down">Dashboard KirimKu&nbsp;<span class="underline">Pengiriman Kilat</span></h1>
                </div>
            </div>
            <div class="col-md-6">
                <div>
                    <svg width="500px" height="500px" viewBox="0 0 1024 1024" class="icon" version="1.1"
